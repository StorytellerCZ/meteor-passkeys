  ...
  fields: () => [
    {
      ...
      fieldLabel: 'Email',
      autocomplete: `email ${Package['accounts-passkeys'] && !loginButtonsSession.get('inSignupFlow') ? 'webauthn' : ''}`,
      inputType: 'email',
  ...
  fields: () => {
    const loginFields = [
      {fieldName: 'username-or-email', fieldLabel: 'Username or Email',
        autocomplete: `username email ${Package['accounts-passkeys'] ? 'webauthn' : ''}`,
